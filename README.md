...
* [1] Include the script element linking the `axios` library in your HTML.
* [1] If you do not remember the code you can find it [here](https://github.com/axios/axios).

#### Option 2 (installing Axios with npm)

* [1] Navigate to the root of the project with your command line.
* [1] Run `npm install axios` to download the dependency (it will be added to the `package.json` file).
* [1] At the top of the `GitHubCard/index.js` file, type `import axios from 'axios';`

### Part 1: Requesting Data from the GitHub API

* [1] Follow the instructions found in the `GitHubCard/index.js` file to request data from the GitHub API.
